...
import { LayoutDashboard, Building2, ScrollText, ArrowLeftRight, ShieldCheck, Flag, Palette, CreditCard, Users, KeyRound, LifeBuoy, ImageIcon, Bell, Sparkles, Activity, ShieldAlert, Code2, FileText } from "lucide-react";
...
const navItems = [
  ...
  { label: "CMS", href: "/platform-admin/cms", icon: FileText },
