...
**Resolved 2026-08-25**: migrations `0026_module_registry.sql` and `0027_industry_registry.sql` applied to the live "Axis" project once CLI access was restored (re-login to the correct account); `database.types.ts` regenerated and reconciled. See [CHANGELOG.md](CHANGELOG.md).
