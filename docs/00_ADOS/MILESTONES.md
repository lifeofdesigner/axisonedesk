...
| M4: Industry Module Engine | In Progress — Phases 1, 2, 3a, 3b (both slices) shipped and live, code-complete; feature flag OFF pending human end-to-end QA (ADR-010) | See [ROADMAP.md](ROADMAP.md) and [.ai/02_INDUSTRY_ENGINE.md](../../.ai/02_INDUSTRY_ENGINE.md). |
