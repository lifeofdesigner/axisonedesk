...
| M4: Industry Module Engine | In Progress — Phases 1-2 (Module Registry, Industry/Org-Type Registry) schema/API shipped, neither applied to live DB | See [ROADMAP.md](ROADMAP.md) and [.ai/02_INDUSTRY_ENGINE.md](../../.ai/02_INDUSTRY_ENGINE.md). |
