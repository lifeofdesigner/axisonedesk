...
| M4: Industry Module Engine | In Progress — Phases 1, 2, 3a shipped and live; Phase 3b (onboarding rewrite) not started | See [ROADMAP.md](ROADMAP.md) and [.ai/02_INDUSTRY_ENGINE.md](../../.ai/02_INDUSTRY_ENGINE.md). |
